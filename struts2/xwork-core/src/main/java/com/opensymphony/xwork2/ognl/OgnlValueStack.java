...
/**
 * OGNL实现允许动态的ognl表达式对其进行评估. 
 *
 * @author Patrick Lightbody
 * @author tm_jee
 * @version $Date: 2012-07-21 04:44:32 +0800 (Sat, 21 Jul 2012) $ $Id: OgnlValueStack.java 1363947 2012-07-20 20:44:32Z lukaszlenart $
 */
public class OgnlValueStack implements Serializable, ValueStack, ClearableValueStack, MemberAccessValueStack {
    ...
    CompoundRoot root;// ognl复合根
    transient Map<String, Object> context;// 额外其他context
    
    Class defaultType;
    Map<Object, Object> overrides;// 用来映射，为表达式取别名
    ...
    protected void setRoot(XWorkConverter xworkConverter, CompoundRootAccessor accessor, CompoundRoot compoundRoot,
        ...
        // 使用compoundRoot作为ognl的root
        // 将标准的ognl context追加到传入的context中，这样ongl使用追加后的context来评估表达式
