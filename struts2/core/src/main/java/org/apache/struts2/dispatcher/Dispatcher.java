/*
 * $Id: Dispatcher.java 1357481 2012-07-05 07:31:14Z lukaszlenart $
 *
...
public class Dispatcher {
    ...
    /**
     * 线程本地变量，在一个请求的线程中都使用这个实例，设置为static便于传递这个变量
     */
    ...
    /**
     * 为mapping加载Action类并调用合适的Action方法，或者直接到Result。
     * 首先从指定的参数创建action的context.
     * 从指定的action名称加载ActionProxy
     * 然后执行Action方法，通过reponse对象输出结果。
     * 没有找到Actions，则SendError使用404代码
     * 通过抛出ServletException来报告错误
     *
    ...
    public void serviceAction(HttpServletRequest request, HttpServletResponse response, ServletContext context,
        ...
        // 如果之前有一个valuestack, 那么就创建一个副本，并传递过去，供新的Action使用
