...
public final class CharsetUtil {
    ...
    /**
     * 16-位 UTF (UCS Transformation Format) whose 字节顺序通过可选的 byte-order mark来标识
     */
    public static final Charset UTF_16 = Charset.forName("UTF-16");

    /**
     * 16-位 UTF (UCS Transformation Format) 但字节顺序是 big-endian
     */
    public static final Charset UTF_16BE = Charset.forName("UTF-16BE");

    /**
     * 16-位 UTF (UCS Transformation Format) 但字节顺序是 little-endian
     */
    public static final Charset UTF_16LE = Charset.forName("UTF-16LE");

    /**
     * 8-位 UTF (UCS Transformation Format)
     */
    ...
    /**
     * 7-位 ASCII, as known as ISO646-US or the Basic Latin block of the
